...
<script>
  function check_input() {                          // 입력값 확인 함수
...
?>
	    <form  name="board_form" method="post" action="board_modify.php?num=<?=$num?>&page=<?=$page?>" enctype="multipart/form-data">               <!-- 수정 폼 -->
	    	 <ul id="board_form">
				<li>
